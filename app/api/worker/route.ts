...
export async function POST(req: Request) {
  try {
    ...
    await saveClient(clientSlug, {
      ...
      target_audience: userInput.targetAudience || null,
      site_type: userInput.siteType || null,
      pages: Array.isArray(userInput.pages) ? userInput.pages : [],
      features: features,
      style: userInput.style || null,
      color_prefs: userInput.colorPrefs || null,
      references: userInput.references || null,
      additional_notes: userInput.additionalNotes || null,
      pricing_method: userInput.pricingMethod || null,
      pricing_details: userInput.pricingDetails || null,
      domain: userInput.domain || null,
      business_address: userInput.businessAddress || null,
      facebook_page: userInput.facebookPage || null,
