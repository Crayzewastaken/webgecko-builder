...
export default function ClientPanel({ c, secret, onClose, toast, dark = true }: ClientPanelProps) {
  ...
  const [customHeadHtml, setCustomHeadHtml] = useState(c.customHeadHtml||"");
  const [customBodyHtml, setCustomBodyHtml] = useState(c.customBodyHtml||"");
                ...
                <div style={{display:"flex",flexDirection:"column" as const,gap:14}}>
                  <div>
                    ...
                    <textarea
                      ...
                      rows={6}
                      style={{width:"100%",boxSizing:"border-box" as const,background:T.bg,border:`1px solid ${T.border}`,borderRadius:7,padding:"10px 14px",color:T.text,fontSize:12,outline:"none",fontFamily:"monospace",resize:"vertical" as const,lineHeight:1.5}}
                    />
                  </div>
                  <div>
